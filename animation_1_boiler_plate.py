...
# canvas variables
width = 1500 # adjust for width of canvas
height = 780 # adjust for height of canvas
...
# import assets
sprite_sheet = pygame.image.load("predeter.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 16 # code the number of sprite images your sprite sheet has
